...
import com.zhang.transitionsample.databinding.ActivityAnimations2Binding;
import com.zhang.transitionsample.sample.Sample;

import java.util.ArrayList;
import java.util.List;

public class Animations2Activity extends BaseActivity {
    ...
    private void bindData() {
        ...
        binding.setAnimations2Sample(sample);
    }
    ...
    private void setupLayout() {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                TransitionManager.go(scene1,new MyTransition().setDuration(2000));// new ChangeBounds());
            }
        });
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TransitionManager.go(scene2, TransitionInflater.from(Animations2Activity.this).
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TransitionManager.go(scene3, TransitionInflater.from(Animations2Activity.this).
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TransitionManager.go(scene4, TransitionInflater.from(Animations2Activity.this).
        ...
        // new Scene(sceneRoot, sceneRoot.findViewById(R.id.activity_animations_scene0));
